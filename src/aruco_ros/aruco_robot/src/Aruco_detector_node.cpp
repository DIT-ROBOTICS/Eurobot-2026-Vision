...
public:
    ArucoDetectorNode() : Node("aruco_detector_node") {
        ...
        image_sub_ = this->create_subscription<sensor_msgs::msg::Image>(
            camera_name_prefix_ + "/color/image_raw", 10, std::bind(&ArucoDetectorNode::image_callback, this, _1));
        info_sub_ = this->create_subscription<sensor_msgs::msg::CameraInfo>(
            camera_name_prefix_ + "/color/camera_info", 10, std::bind(&ArucoDetectorNode::camera_info_callback, this, _1));
